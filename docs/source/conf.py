...
latex_documents = [
    (master_doc, 'torchfitter.tex', 'torchfitter Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'torchfitter', 'torchfitter Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'torchfitter', 'torchfitter Documentation',
     author, 'torchfitter', 'One line description of project.',
     'Miscellaneous'),
]
