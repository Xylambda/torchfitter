...
htmlhelp_basename = "torchfitter-doc"
...
man_pages = [
    (master_doc, "torchfitter", "torchfitter Documentation", [author], 1)
]
...
napoleon_use_rtype = (
    False  # show argument name and return type in the same line
)
napoleon_numpy_docstring = (
    True  # the only allowed format for docstring is numpy style
)
...
autodoc_member_order = (
    "alphabetical"  # {'alphabetical','groupwise','bysource'}
)
